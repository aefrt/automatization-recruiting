...
- Научил его собирать количество страниц
- Собрал все данные (но пока только 1 скрейпером)
- Опыт работы: число + 1–2 работа
...
- Запустить уже скрейпинг, собрать нормалное кол-во данных, чтобы начать их анализироавть. 
