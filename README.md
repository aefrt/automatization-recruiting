...
- В скрейпинг запросов добавить возможность добавлять новые данные без удаления старых. В скрейпинг фичей также добавить возможность обновления таблицы с сохранением предыдущих данных (простой способ уже написан, нужен ли более сложный?)
